...
export class ContainerRegistry extends EventDispatcher {
    ...
    private _bindingByContainer: Map<typeof Object3D, ContainerBinding> = new Map<typeof Object3D, ContainerBinding>();
     ...
     * @private
     */
    public addContainer(container: typeof Object3D): ContainerBinding {
     ...
     * @private
     */
    public removeContainer(container: typeof Object3D): ContainerBinding {
     ...
     * @private
     */
    public findParentBinding(target: typeof Object3D): ContainerBinding {
        let parent: typeof Object3D = target.parent;
        while (parent) {
     ...
     * @private
     */
    public getBinding(container: typeof Object3D): ContainerBinding {
    ...
    private createBinding(container: typeof Object3D): ContainerBinding {
