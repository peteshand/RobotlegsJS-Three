...
export class ViewManager extends EventDispatcher implements IViewManager {
    ...
    private _containers: typeof Object3D[] = [];

    /**
     * @inheritDoc
     */
    public get containers(): typeof Object3D[] {
     ...
     * @inheritDoc
     */
    public addContainer(container: typeof Object3D): void {
     ...
     * @inheritDoc
     */
    public removeContainer(container: typeof Object3D): void {
    ...
    private validContainer(container: typeof Object3D): boolean {
